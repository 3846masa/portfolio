enum materialColors {
  ...
  dark_primary = 'rgba(0, 0, 0, 0.87)',
  dark_secondary = 'rgba(0, 0, 0, 0.54)',
  dark_disabled = 'rgba(0, 0, 0, 0.38)',
  dark_dividers = 'rgba(0, 0, 0, 0.12)',
  dark_icon_active = 'rgba(0, 0, 0, 0.54)',
  dark_icon_inactive = 'rgba(0, 0, 0, 0.38)',
  light_primary = 'rgba(255, 255, 255, 1)',
  light_secondary = 'rgba(255, 255, 255, 0.7)',
  light_disabled = 'rgba(255, 255, 255, 0.5)',
  light_dividers = 'rgba(255, 255, 255, 0.12)',
  light_icon_active = 'rgba(255, 255, 255, 1)',
  light_icon_inactive = 'rgba(255, 255, 255, 0.5)',
  white = '#ffffff',
  black = '#000000',
}
